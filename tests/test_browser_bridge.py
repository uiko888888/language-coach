...
class BrowserBridgeTests(unittest.TestCase):
    ...
    def test_lexicon_compare_returns_reviewed_boundaries_and_evidence_fallback(self):
        ...
        self.assertEqual(sum(group["reviewed"] for group in catalog["groups"]), 85)
    ...
    def test_comparison_training_api_saves_wrong_boundary_to_review_and_undoes_rating(self):
        ...
        self.assertEqual(training["quality"]["published"], 68)
        self.assertEqual(training["quality"]["reviewed"], 100)
