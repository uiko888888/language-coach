...
| Dictionary and word chunks | 8.2/10 local, 8.0/10 distributable | Eudic, Cambridge, Collins, Merriam-Webster | Private Oxford coverage improves this user's lookup substantially, but it cannot become bundled public coverage; 135 confusion groups remain candidates | Review remaining groups and turn boundaries into active recall |
