...
| Dictionary and word chunks | 7.3/10 | Eudic, Cambridge, Collins, Merriam-Webster | Multi-term comparison now separates reviewed boundaries from open evidence, but only one group has editorial-level guidance and audio coverage remains incomplete | Expand reviewed groups from real query demand and improve sense ranking without weakening provenance |
