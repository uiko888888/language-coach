...
| Dictionary and word chunks | 7.5/10 | Eudic, Cambridge, Collins, Merriam-Webster | Single entries now prioritize an English concept and verified usage frame, but only one group has manually curated boundaries and audio coverage remains incomplete | Add sense-aware saving and expand curated groups without weakening provenance |
