...
| Dictionary and word chunks | 6.2/10 | Eudic, Cambridge, Collins, Merriam-Webster | Query correction, history, 200,000 wordfreq rows and 77,344 attributable Tatoeba pairs are active; Kaikki polysemy, phrases and Chinese reverse lookup remain absent | Import a licensed Kaikki subset and pass the remaining quality groups |
