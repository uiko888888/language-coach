...
| Review scheduling | 6.4/10 | Anki/FSRS | Validated FSRS adapter and migration replay now work; long-term retention fitting and management controls remain | Collect real logs, calibrate retention, add pause/reset/new-card limits |
