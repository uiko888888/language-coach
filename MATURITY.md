...
| Dictionary and word chunks | 8.1/10 local, 7.9/10 distributable | Eudic, Cambridge, Collins, Merriam-Webster | Private Oxford coverage improves this user's lookup substantially, but it cannot become bundled public coverage; source management and one HUFF/CDIC import remain incomplete | Finish private source controls and expand redistributable Chinese coverage |
