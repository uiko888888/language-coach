...
> 当前版本：`0.8.0-alpha.2`。项目仍处于 Alpha 阶段，数据结构和交互可能继续调整。
...
- 练习中心可选择综合、阅读、选词模式和当前考试专项题型，并从当前文章生成练习；首字母填空已移除，目前生成器仍是可验证的规则基线，AI 出题模型单独规划。
...
- 同一篇文章可按考试专项生成阅读理解、判断、匹配、摘要填空和通用选词练习；不符合考试结构的首字母填空已移除。
