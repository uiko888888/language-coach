...
> 当前版本：`0.8.0-alpha.11.2`。项目仍处于 Alpha 阶段，数据结构和交互可能继续调整。
...
版本历史见 [`CHANGELOG.md`](CHANGELOG.md)，当前版本见 [`VERSION`](VERSION)。版本目标与验收见 [`PROJECT_PLAN.md`](PROJECT_PLAN.md)；产品定位、路线图、真实完成状态、关键决定和相关项目调研分别见 [`PRODUCT.md`](PRODUCT.md)、[`ROADMAP.md`](ROADMAP.md)、[`STATUS.md`](STATUS.md)、[`DECISIONS.md`](DECISIONS.md) 和 [`RESEARCH.md`](RESEARCH.md)。
