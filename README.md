...
> 当前版本：`0.8.0-alpha.24.0`。项目仍处于 Alpha 阶段，数据结构和交互可能继续调整。
...
- 英文目标词块或参考表达可进入统一复习，并保留文章来源；任意错句编辑保存将在下一阶段补齐。
- `alpha.24.1` 计划增加证据感知 AI 五维反馈与近义词使用边界；`alpha.24.2` 计划增加本机录音、脱稿复述和观点表达。当前版本尚未实现口语录音。
