...
Language Coach 将文章阅读、词典查询、生词积累、一文多练、错题讲解和网页划词收集放在同一套学习流程中。当前版本优先强化英语，支持 IELTS、TOEFL、专四、专八、GRE、GMAT 等训练风格；法语和西班牙语内容仍在后续规划中。

> 当前版本：`0.7.0-alpha.6`。项目仍处于 Alpha 阶段，数据结构和交互可能继续调整。
...
- 支持 IELTS、TOEFL、专四、专八、GRE、GMAT 和通用出题风格。
- 做题时保留原文，方便定位证据。
- 答错后立即展示答案、证据和考点讲解。
...
版本历史见 [`CHANGELOG.md`](CHANGELOG.md)，当前版本见 [`VERSION`](VERSION)。
