...
async function run() {
  ...
  try {
    ...
    if (version.app_version !== "0.8.0-alpha.24.9" || version.database_schema_version !== 19) {
  ...
  process.stdout.write("Practice one-click translation workflow passed on schema 19.\n");
}
