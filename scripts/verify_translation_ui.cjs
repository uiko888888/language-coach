...
async function run() {
  ...
  try {
    ...
    if (version.app_version !== "0.8.0-alpha.25.4" || version.database_schema_version !== 21) {
  ...
  process.stdout.write("Practice one-click translation workflow passed on schema 21.\n");
}
